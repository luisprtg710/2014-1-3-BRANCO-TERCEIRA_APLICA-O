...
def renomear_questoes_simples():
    pasta = "1-7" # ATUALIZAR com o nome da pasta das questões que você vai arrumar 
    ...
    for i in range(2, 8+1):    # atualize seu for com o número da primeira imagem "parte_AlgumaCoisa.png" até o número da última imagem "parte_AlgumaCoisa.png" mais 1 da pasta
